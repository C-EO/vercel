...
Defined in: [packages/functions/src/oidc/aws-credentials-provider.ts:70](https://github.com/C-EO/vercel/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L70)
