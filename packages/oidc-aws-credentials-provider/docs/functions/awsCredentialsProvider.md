...
Defined in: [aws-credentials-provider.ts:107](https://github.com/C-EO/vercel/blob/main/packages/oidc-aws-credentials-provider/src/aws-credentials-provider.ts#L107)
