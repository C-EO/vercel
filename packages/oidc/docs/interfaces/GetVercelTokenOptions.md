...
Defined in: [packages/oidc/src/token-util.ts:18](https://github.com/C-EO/vercel/blob/main/packages/oidc/src/token-util.ts#L18)
...
Defined in: [packages/oidc/src/token-util.ts:24](https://github.com/C-EO/vercel/blob/main/packages/oidc/src/token-util.ts#L24)
